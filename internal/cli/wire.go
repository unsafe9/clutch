...
// file backend additionally satisfies correlate's narrow resolver — so the CLI
// can wire it straight into the pure correlation core. These assertions fail at
// compile time if any port drifts.
var (
